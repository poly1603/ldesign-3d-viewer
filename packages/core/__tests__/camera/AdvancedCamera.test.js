...
describe('AdvancedCamera', () => {
    ...
    describe('平滑移动', () => {
        ...
        it('应该能够平滑旋转', async () => {
            ...
            await advancedCamera.smoothMoveTo(camera.position.clone(), targetRotation, undefined, 50);
        ...
        it('应该能够平滑改变FOV', async () => {
            ...
            const targetFov = 120;
            await advancedCamera.smoothMoveTo(camera.position.clone(), undefined, targetFov, 50);
...
//# sourceMappingURL=AdvancedCamera.test.js.map