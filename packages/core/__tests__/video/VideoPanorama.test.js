...
import { VideoPanorama } from '../../src/video/VideoPanorama';
...
describe('VideoPanorama', () => {
    ...
    describe('基本功能', () => {
        it('应该能够创建 VideoPanorama', () => {
            const options = { sources: videoSources };
    ...
    describe('视频事件', () => {
        ...
        it('视频错误时应该触发事件', () => {
            ...
            mockVideo.error = { code: MediaError.MEDIA_ERR_NETWORK };
...
//# sourceMappingURL=VideoPanorama.test.js.map