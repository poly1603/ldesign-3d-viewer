...
import { AdvancedGestureControls, type GestureEvent } from '../../src/controls/AdvancedGestureControls'
...
describe('AdvancedGestureControls', () => {
  ...
  let controls: AdvancedGestureControls
  let gestureCallback: (event: GestureEvent) => void
  let capturedGestures: GestureEvent[]

  beforeEach(() => {
    element = document.createElement('div')
    capturedGestures = []
    gestureCallback = vi.fn((event: GestureEvent) => {
