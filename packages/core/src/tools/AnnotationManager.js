...
export class AnnotationManager {
     ...
     * 渲染矩形标注
     */
    renderRectangle(annotation, x, y) {
        const ctx = this.ctx;
        const style = annotation.style;
        const width = 100;
        const height = 60;
     ...
     * 获取指定位置的标注
     */
    getAnnotationAtPosition(clientX, clientY) {
