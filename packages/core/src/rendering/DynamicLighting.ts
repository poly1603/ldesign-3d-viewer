...
export class DynamicLighting {
  ...
  public updateLight(id: string, updates: Partial<LightConfig>): void {
    ...
    if (light instanceof THREE.SpotLight) {
      if (updates.angle !== undefined) light.angle = updates.angle;
      if (updates.penumbra !== undefined) light.penumbra = updates.penumbra;
      if (updates.distance !== undefined) light.distance = updates.distance;
