...
export class TileManager {
    constructor(scene, camera, format) {
        this.rootNodes = [];
        this.visibleTiles = new Set();
        this.loadingTiles = new Set();
        this.maxConcurrentLoads = 4;
        this.maxCachedTiles = 100;
        this.cacheCleanupInterval = 5000; // ms
     ...
     * 判断是否应该细分瓦片
     */
    shouldSubdivideTile(node, distance) {
        // 基于距离的 LOD 策略
    ...
    createTileMesh(node) {
        ...
        // 创建球面几何体片段
        const geometry = new THREE.SphereGeometry(500, // 半径
        32, // 宽度分段
        32, // 高度分段
        thetaStart, thetaEnd - thetaStart, phiStart, phiEnd - phiStart);
