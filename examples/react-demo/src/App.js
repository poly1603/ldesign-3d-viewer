...
function App() {
    ...
    const [lastHotspotClick, setLastHotspotClick] = useState(null);
    ...
    return (<div className="app">
      ...
      {loadingProgress > 0 && loadingProgress < 100 && (<div className="progress-container">
      ...
      <PanoramaViewer ref={viewerRef} image={images[currentImageIndex]} autoRotate={autoRotate} fov={75} viewLimits={viewLimits} showMiniMap={showMiniMap} width="100%" height="600px" onReady={handleReady} onError={handleError} onProgress={handleProgress} onHotspotClick={handleHotspotClick}/>
      ...
      <div className="info-panel">
        ...
        {lastHotspotClick && (<div className="info-row">
